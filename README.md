...
This project is a sample YouTrack App that adds a `MAIN_MENU_ITEM` entry showing:
...
- A permanent YouTrack token (for `youtrack-app upload`)
...
2. **Manual ZIP upload**
   ...
   > **Shortcut:** This repository also contains a pre-built archive (`prebuilt/youtrack-app.zip`). You can upload that ZIP directly if you don’t want to build locally, but rebuild the bundle whenever you modify the source.
